...
sealed class ScreenState : NavigationComponent {
     ...
     */
    data class PrivacyPolicy(override val typeId: String = TYPE_ID_SCREEN_PRIVACY_POLICY) : ScreenState()
     ...
     * including the server URL for network communication and any associated error messages.
     *
